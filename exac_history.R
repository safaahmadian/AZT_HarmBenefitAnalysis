...
print("severe exacerbations") 
mean(year1_0exac$obsExac_severe.y2)/mean(year1_1exac$obsExac_severe.y2)
mean(year1_2mod1sev$obsExac_severe.y2)/mean(year1_1exac$obsExac_severe.y2)
mean(year1_2exac$obsExac_severe.y2)/mean(year1_1exac$obsExac_severe.y2)

rateratio(sum(year1_0exac$obsExac_severe.y2), sum(year1_1exac$obsExac_severe.y2),nrow(year1_0exac) , nrow(year1_1exac), conf.level=0.95) 
# 0.16 (0.12 - 0.20)
rateratio(sum(year1_2mod1sev$obsExac_severe.y2), sum(year1_1exac$obsExac_severe.y2),nrow(year1_2mod1sev) , nrow(year1_1exac), conf.level=0.95) 
# 1.36 (1.17 - 1.58)
rateratio(sum(year1_2exac$obsExac_severe.y2), sum(year1_1exac$obsExac_severe.y2),nrow(year1_2exac) , nrow(year1_1exac), conf.level=0.95) 
#1.26 (1.07 - 1.48)

#-----------------------------------------

mean(year1_2mod1sev$obsExac_severe.y2)/mean(year1_2exac$obsExac_severe.y2)

mean(year1_2mod1sev$obsExac_moderate.y2)/mean(year1_2exac$obsExac_moderate.y2)
...
nrow(year1_2mod1sev) / nrow(year1_1exac)

nrow(year1_1exac) / nrow(joined_data)

nrow(year1_0exac) / nrow(joined_data)
